    ...
    <el-form :model="queryParam" ref="queryForm" :inline="true">
      ...
      <el-form-item>
        <el-button
          type="primary"
          @click="submitForm"
          v-has-perm="['train:teacher:page']"
          >查询</el-button
        >
        <el-button @click="clearForm">重置</el-button>
        <router-link :to="{ path: '/train/teacher/edit' }" class="link-left">
          <el-button type="primary" v-has-perm="['train:teacher:create']"
            >添加</el-button
          >
        </router-link>
      </el-form-item>
    ...
    >
      ...
      <el-table-column width="150px" label="操作" align="center">
        <template #default="{ row }">
          <router-link
            :to="{ path: '/train/teacher/edit', query: { id: row.id } }"
            class="link-left"
          >
            <el-button
              v-has-perm="['train:teacher:update']"
          ...
          <el-button
            ...
            size="small"
            v-has-perm="['train:teacher:delete']"
            >删除
          </el-button>
        </template>
      </el-table-column>
