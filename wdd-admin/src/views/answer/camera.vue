  ...
  <div class="app-container">
    <div class="wdd-show-row">
      ...
      <el-card class="wdd-show-col">
        ...
        <p><span>是否合格：</span><span>{{ info.passed ? '是' : '否' }}</span></p>
        <p><span>答卷状态：</span><span>{{ info.statusStr }}</span></p>
        <p><span>提交时间：</span><span>{{ info.submitTime }}</span></p>
      </el-card>
    </div>
...
import {camera} from '@/api/examPaperAnswer'

export default {
  name: 'ExamPaperAnswerCamera',
  data() {
    return {
      info: {}
    }
