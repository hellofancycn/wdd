        ...
        <el-table :data="tableData" border fit highlight-current-row style="width: 100%">
            ...
            <el-table-column width="210px" label="操作" align="center">
                <template #default="{ row }">
                    ...
                    <el-button @click="examPaperBuildAction(row, 2)" v-has-perm="['exam:paper:build:copy']" size="small"
                        class="link-left wdd-page-action-button">复制
                    </el-button>
                    <el-button type="danger" @click="examPaperBuildDelete(row)" size="small"
                        class="link-left wdd-page-action-button" v-has-perm="['exam:paper:build:delete']">删除
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
