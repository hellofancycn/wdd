  ...
  <div class="app-container">
    <el-form :model="queryParam" ref="queryForm" :inline="true">
      ...
      <el-form-item label="人员类别：">
        <tree-select
          v-model="queryParam.departmentIdList"
          :data="departmentTree"
          :clearable="true"
          placeholder="人员类别"
        />
      ...
      <el-form-item>
        ...
        <el-popover placement="bottom" trigger="click" :width="240">
          <template #reference>
            <el-button
              type="primary"
              class="link-left"
              v-has-perm="['user:employee:import']"
              >导入
            </el-button>
          </template>
          <div class="wdd-popover-content">
            <a
              target="_blank"
              :href="`${VITE_APP_RESOURCE_URL}/template/file/员工导入模板.xlsx`"
        ...
        <el-button
          ...
          class="link-left"
          @click="userExport"
          v-has-perm="['user:employee:export']"
          >导出
        </el-button>
        <router-link :to="{ path: '/user/employee/edit' }" class="link-left">
          <el-button type="primary" v-has-perm="['user:employee:create']"
            >添加</el-button
          >
        </router-link>
      </el-form-item>
    ...
    >
      ...
      <el-table-column width="300px" label="操作" align="center">
        <template #default="{ row }">
          ...
          >
            <el-button
              v-has-perm="['user:employee:update']"
              size="small"
          ...
          <el-button
            ...
            v-has-perm="['user:employee:delete']"
            >删除
          </el-button>
        </template>
      </el-table-column>
