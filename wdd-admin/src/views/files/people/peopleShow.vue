    ...
    <div class="app-container">
      <el-form :model="form" ref="form" label-width="200px" v-loading="formLoading"  :rules="rules" >
        ...
        <el-form-item label="密码：">
          <el-input v-model="form.user.password"  disabled></el-input>
        </el-form-item>
        <el-form-item label="真实姓名：" prop="user.realName"  required>
          <el-input v-model="form.user.realName" disabled></el-input>
        </el-form-item>
        <el-form-item label="人员类别：" prop="departmentId" >
          <el-tree-select v-model="form.user.departmentId" :data="departmentTree" check-strictly :render-after-expand="true"
            default-expand-all placeholder="人员类别" disabled/>
        </el-form-item>
        <el-form-item label="头像：" prop="imagePath">
          <el-upload class="upload" action="/api/upload/folder/file" accept=".jpg,.png" :data="{ folder: 'profile' }"
            :show-file-list="false" :on-progress="uploadProgress" :on-success="uploadSuccess" :on-error="uploadError" disabled>
        ...
        <el-form-item label="职位：" prop="jobTitle">
          <el-input v-model="form.user.jobTitle" disabled></el-input>
        </el-form-item>
        <el-form-item label="工号：" prop="workNo">
          <el-input v-model="form.user.workNo" disabled></el-input>
        </el-form-item>
        <el-form-item label="身份证号：" prop="user.idCard" >
          <el-input v-model="form.user.idCard" disabled></el-input>
        </el-form-item>
        <el-form-item label="年龄：" prop="user.age" required>
          <el-input v-model.number="form.user.age" disabled></el-input>
        </el-form-item>
        <el-form-item label="性别：">
          <el-select v-model="form.user.sex" placeholder="性别" clearable disabled>
            <el-option v-for="item in EnumMap.user.sexEnum" :key="item.key" :value="item.key"
                       :label="item.value"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="出生日期：">
          <el-date-picker v-model="form.user.birthDay" value-format="YYYY-MM-DD" type="date" placeholder="选择日期" disabled/>
        </el-form-item>
        ...
        <el-form-item label="民族：" prop="userExtend.nation">
          <el-input v-model="form.userExtend.nation" disabled></el-input>
        </el-form-item>
        <el-form-item label="籍贯：" prop="nativePlace">
          <el-input v-model="form.userExtend.nativePlace" disabled></el-input>
        </el-form-item>
        <el-form-item label="健康状况：" prop="health">
          <el-input v-model="form.userExtend.health" disabled></el-input>
        </el-form-item>
        <el-form-item label="政治面貌：" prop="politic">
          <el-input v-model="form.userExtend.politic" disabled></el-input>
        </el-form-item>
        <el-form-item label="入党时间：">
          <el-date-picker v-model="form.userExtend.partyTime" type="date" placeholder="选择日期" value-format="YYYY-MM-DD" disabled/>
        </el-form-item>
        <el-form-item label="参加工作时间：">
          <el-date-picker v-model="form.userExtend.workTime" type="date" placeholder="选择日期" value-format="YYYY-MM-DD" disabled />
        </el-form-item>
        <el-form-item label="全日制教育：" prop="schoolEducation">
          <el-input v-model="form.userExtend.schoolEducation" disabled></el-input>
        </el-form-item>
        <el-form-item label="全日制教育毕业院校及专业：" prop="schoolEducationMajor">
          <el-input v-model="form.userExtend.schoolEducationMajor" disabled></el-input>
        </el-form-item>
        <el-form-item label="在职教育：" prop="jobEducation">
          <el-input v-model="form.userExtend.jobEducation" disabled></el-input>
        </el-form-item>
        <el-form-item label="在职教育毕业院校及专业：" prop="jobEducationMajor">
          <el-input v-model="form.userExtend.jobEducationMajor" disabled></el-input>
        </el-form-item>
        <el-form-item label="工作单位及职务/工种：" prop="workUnitType">
          <el-input v-model="form.userExtend.workUnitType" disabled></el-input>
        </el-form-item>
        <el-form-item label="通信地址及邮编：" prop="mailAddressCode">
          <el-input v-model="form.userExtend.mailAddressCode" disabled></el-input>
        </el-form-item>
        <!-- <el-form-item label="状态：" prop="status" >
          <el-select v-model="form.user.status" placeholder="状态" disabled>
