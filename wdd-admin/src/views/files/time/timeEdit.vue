        ...
        <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
            ...
            user.realName }} - {{ user.userName }}
                ...
                <el-tab-pane label="老师签到" name="three">
                    <el-upload accept=".jpg,.png" name="file" :data="{ folder: 'yqyd' }"
                        action="/api/upload/folder/file" :on-progress="uploadProgress" :on-success="upload"
                    ...
                    <el-table :data="form.teacherSign" width="1000px">
                        ...
                        <el-table-column width="300px" label="操作" align="center">
                            <template #default="{ row }">
                                <el-button type="danger" @click="teacherSignDelete(row)"
                                    class="link-left wdd-button-mini" size="small">删除
                                </el-button>
        ...
        <el-dialog v-model="courseWarePage.showDialog" width="90%">
            <el-form :model="courseWarePage.queryParam" ref="courseWareQueryForm" :inline="true">
                ...
                <el-form-item label="分类：">
                    <tree-select v-model="courseWarePage.queryParam.courseWareArchiveIdList"
                        :data="courseWareArchiveTree" :clearable="true" placeholder="培训分类" />
                </el-form-item>
            ...
            <el-table :data="courseWarePage.tableData" @row-click="courseWareClick" border fit highlight-current-row
                ...
                <el-table-column width="80px" label="操作" align="center">
                    <template #default="{ row }">
                        <el-button class="wdd-button-mini" size="small"
