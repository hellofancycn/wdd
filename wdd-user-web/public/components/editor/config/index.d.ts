...
import { UploadAudioHooksType } from './audio';
import { UploadAttachmentHooksType } from './attachment';
...
export declare type ConfigType = {
    ...
    onlineAttachmentCheck: Function;
    onlineAttachmentCallback: Function;
    ...
    uploadAttachmentParams: DicType;
    uploadAttachmentParamsWithUrl: boolean;
    uploadAttachmentHeaders: DicType;
    uploadAttachmentHooks: UploadAttachmentHooksType;
    uploadAttachmentTimeout: number;
    withAttachmentCredentials: boolean;
    customUploadAttachment: Function | null;
    customInsertAttachment: Function | null;
